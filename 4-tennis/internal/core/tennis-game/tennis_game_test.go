...
func TestTennisGame_GivenPlayerOneHasAdvantage_WhenPlayerTwoScores_ThenGameIsDeuce(t *testing.T) {
	//arrange
	game := newTestGame(player.FOURTY, player.FOURTY)
	game.Player(PLY_ONE).Scored()
...
func TestTennisGame_GivenPlayerTwoHasAdvantage_WhenPlayerOneScores_ThenGameIsDeuce(t *testing.T) {
	//arrange
	game := newTestGame(player.FOURTY, player.FOURTY)
	game.Player(PLY_TWO).Scored()
...
func TestTennisGame_GivenPlayerOneHasScoreFourtyAndPlayerTwoHasScoreThirty_WhenPlayerTwoScores_ThenGameIsDeuce(t *testing.T) {
	//arrange
...
func TestTennisGame_GivenPlayerTwoHasScoreFourtyAndPlayerOneHasScoreThirty_WhenPlayerOneScores_ThenGameIsDeuce(t *testing.T) {
	//arrange
